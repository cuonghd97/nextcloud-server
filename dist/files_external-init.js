...
const action = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_5__.FileAction({
  ...
  async exec(node) {
    const {
      login,
      password
    } = await new Promise(resolve => (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.spawnDialog)((0,vue__WEBPACK_IMPORTED_MODULE_8__.defineAsyncComponent)(() => Promise.all(/*! import() */[__webpack_require__.e("core-common"), __webpack_require__.e("apps_files_external_src_views_CredentialsDialog_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! ../views/CredentialsDialog.vue */ "./apps/files_external/src/views/CredentialsDialog.vue"))), {}, args => {
      resolve(args);
    }));
    if (login && password) {
  ...
  async renderInline(node) {
    ...
    try {
      ...
      if (config.status !== _utils_credentialsUtils__WEBPACK_IMPORTED_MODULE_5__.STORAGE_STATUS.SUCCESS) {
        throw new Error(config?.statusMessage || (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('files_external', 'There was an error with this external storage.'));
      }
      return null;
    } catch (error) {
...
/******/ 			return "" + chunkId + "-" + chunkId + ".js?v=" + {"node_modules_nextcloud_dialogs_dist_chunks_index-D5FJasts_mjs":"08b958f56528298001fd","apps_files_external_src_views_CredentialsDialog_vue":"22bd3d9eb51eb5169d53","data_image_svg_xml_3c_21--_20-_20SPDX-FileCopyrightText_202020_20Google_20Inc_20-_20SPDX-Lice-84639e":"2dcb905bc800668fb1ac"}[chunkId] + "";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=files_external-init.js.map?v=3e1966c444097dd7cf0d