...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  computed: {
    ...
    updateButtonText() {
      ...
      return t('settings', 'Update to {version}', {
        version: this.app?.update
      });
    },
    enableButtonText() {
      if (this.app?.app_api) {
        if (this.app && this.app?.status?.action && this.app?.status?.action === 'deploy') {
          return t('settings', '{progress}% Deploying …', {
            progress: this.app?.status?.deploy ?? 0
          });
        }
        if (this.app && this.app?.status?.action && this.app?.status?.action === 'init') {
          return t('settings', '{progress}% Initializing …', {
            progress: this.app?.status?.init ?? 0
          });
        }
    ...
    defaultDeployDaemonAccessible() {
      if (this.app?.app_api) {
        ...
        if (this.app?.daemon?.accepts_deploy_id === 'docker-install' && this.appApiStore.getDefaultDaemon?.name === this.app?.daemon?.name) {
  ...
  methods: {
    ...
    canLimitToGroups(app) {
      if (app.types && app.types.includes('filesystem') || app.types.includes('prelogin') || app.types.includes('authentication') || app.types.includes('logging') || app.types.includes('prevent_group_restriction') || app?.app_api) {
        return false;
      }
      return true;
    },
    ...
    forceEnable(appId) {
      if (this.app?.app_api) {
        this.appApiStore.forceEnableApp(appId).then(() => {
    ...
    enable(appId) {
      if (this.app?.app_api) {
        this.appApiStore.enableApp(appId).then(() => {
          (0,_service_rebuild_navigation_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
        }).catch(error => {
          (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_0__.showError)(error);
        });
    ...
    disable(appId) {
      if (this.app?.app_api) {
        this.appApiStore.disableApp(appId).then(() => {
          (0,_service_rebuild_navigation_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
        }).catch(error => {
          (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_0__.showError)(error);
        });
    ...
    remove(appId) {
      let removeData = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      if (this.app?.app_api) {
        this.appApiStore.uninstallApp(appId, removeData).then(() => {
          (0,_service_rebuild_navigation_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
        }).catch(error => {
          (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_0__.showError)(error);
        });
      } else {
        this.$store.dispatch('appApiApps/uninstallApp', {
          appId,
          removeData
        }).then(response => {
          (0,_service_rebuild_navigation_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
    ...
    update(appId) {
      if (this.app?.app_api) {
        this.appApiStore.updateApp(appId).then(() => {
          (0,_service_rebuild_navigation_js__WEBPACK_IMPORTED_MODULE_1__["default"])();
        }).catch(error => {
          (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_0__.showError)(error);
        });
...
function useAppIcon(app) {
  ...
  const categoryIcon = (0,vue__WEBPACK_IMPORTED_MODULE_2__.computed)(() => {
    ...
    if (app.value?.app_api) {
      ...
      path = _mdi_js__WEBPACK_IMPORTED_MODULE_3__.mdiCogOutline;
    } else {
      path = [app.value?.category ?? []].flat().map(name => _constants_AppstoreCategoryIcons_ts__WEBPACK_IMPORTED_MODULE_0__["default"][name]).filter(icon => !!icon).at(0) ?? (!app.value?.app_api ? _mdi_js__WEBPACK_IMPORTED_MODULE_3__.mdiCog : _mdi_js__WEBPACK_IMPORTED_MODULE_3__.mdiCogOutline);
    }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   useAppApiStore: () => (/* binding */ useAppApiStore)
/* harmony export */ });
/* harmony import */ var _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nextcloud/axios */ "./node_modules/@nextcloud/axios/dist/index.mjs");
...
const useAppApiStore = (0,pinia__WEBPACK_IMPORTED_MODULE_8__.defineStore)('app-api-apps', {
  state: () => ({
    apps: [],
    updateCount: (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_3__.loadState)('settings', 'appstoreExAppUpdateCount', 0),
    loading: {},
    loadingList: false,
    statusUpdater: null,
    daemonAccessible: (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_3__.loadState)('settings', 'defaultDaemonConfigAccessible', false),
    defaultDaemon: (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_3__.loadState)('settings', 'defaultDaemonConfig', null)
  }),
  getters: {
    ...
    getInitializingOrDeployingApps: state => state.apps.filter(app => app?.status?.action && (app?.status?.action === 'deploy' || app.status.action === 'init' || app.status.action === 'healthcheck') && app.status.type !== '')
  },
  actions: {
    ...
    enableApp(appId) {
      ...
      return (0,_nextcloud_password_confirmation__WEBPACK_IMPORTED_MODULE_1__.confirmPassword)().then(() => {
        return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].post((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_5__.generateUrl)(`/apps/app_api/apps/enable/${appId}`)).then(response => {
          ...
          return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].get((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_5__.generateUrl)('apps/files')).then(() => {
            if (response.data.update_required) {
              (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_2__.showInfo)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.translate)('settings', 'The app has been enabled but needs to be updated.'), {
            ...
            this.setError(appId, (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.translate)('settings', 'Error: This app cannot be enabled because it makes the server unstable'));
          });
        }).catch(error => {
          this.setLoading(appId, false);
          this.setLoading('install', false);
    ...
    async fetchAppStatus(appId) {
      return _api__WEBPACK_IMPORTED_MODULE_6__["default"].get((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_5__.generateUrl)(`/apps/app_api/apps/status/${appId}`)).then(response => {
        ...
        if (Object.hasOwn(response.data, 'error') && response.data.error !== '' && initializingOrDeployingApps.length === 1) {
          clearInterval(this.statusUpdater);
          this.statusUpdater = null;
        }
      }).catch(error => {
...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=script&setup=true&lang=ts":
/*!******************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=script&setup=true&lang=ts ***!
  \******************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_1__.defineComponent)({
  ...
  setup(__props) {
    return {
      __sfc: true,
      mdiFileChart: _mdi_js__WEBPACK_IMPORTED_MODULE_2__.mdiFileChart,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_9__.defineComponent)({
  ...
  setup(__props) {
    const PostType = (0,vue__WEBPACK_IMPORTED_MODULE_9__.defineAsyncComponent)(() => Promise.all(/*! import() */[__webpack_require__.e("core-common"), __webpack_require__.e("apps_settings_src_components_AppStoreDiscover_PostType_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! ./PostType.vue */ "./apps/settings/src/components/AppStoreDiscover/PostType.vue")));
    const CarouselType = (0,vue__WEBPACK_IMPORTED_MODULE_9__.defineAsyncComponent)(() => Promise.all(/*! import() */[__webpack_require__.e("core-common"), __webpack_require__.e("apps_settings_src_components_AppStoreDiscover_PostType_vue"), __webpack_require__.e("apps_settings_src_components_AppStoreDiscover_CarouselType_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! ./CarouselType.vue */ "./apps/settings/src/components/AppStoreDiscover/CarouselType.vue")));
    const ShowcaseType = (0,vue__WEBPACK_IMPORTED_MODULE_9__.defineAsyncComponent)(() => Promise.all(/*! import() */[__webpack_require__.e("core-common"), __webpack_require__.e("apps_settings_src_components_AppStoreDiscover_PostType_vue"), __webpack_require__.e("apps_settings_src_components_AppStoreDiscover_ShowcaseType_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! ./ShowcaseType.vue */ "./apps/settings/src/components/AppStoreDiscover/ShowcaseType.vue")));
...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=script&setup=true&lang=ts":
/*!******************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=script&setup=true&lang=ts ***!
  \******************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _nextcloud_vue_dist_Components_NcIconSvgWrapper_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @nextcloud/vue/dist/Components/NcIconSvgWrapper.js */ "./node_modules/@nextcloud/vue/dist/Components/NcIconSvgWrapper.mjs");
/* harmony import */ var _mdi_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @mdi/js */ "./node_modules/@mdi/js/mdi.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_2__.defineComponent)({
  ...
  setup(__props) {
    const props = __props;
    const gpuSupport = (0,vue__WEBPACK_IMPORTED_MODULE_2__.ref)(props.app?.daemon?.deploy_config?.computeDevice?.id !== 'cpu' || false);
    return {
      __sfc: true,
      props,
      gpuSupport,
      NcAppSidebarTab: _nextcloud_vue_dist_Components_NcAppSidebarTab_js__WEBPACK_IMPORTED_MODULE_0__["default"],
      NcIconSvgWrapper: _nextcloud_vue_dist_Components_NcIconSvgWrapper_js__WEBPACK_IMPORTED_MODULE_1__["default"],
      mdiFileChart: _mdi_js__WEBPACK_IMPORTED_MODULE_3__.mdiFileChart
    };
  }
}));
...
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.runtime.esm.js");
/* harmony import */ var _nextcloud_l10n__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nextcloud/l10n */ "./node_modules/@nextcloud/l10n/dist/index.mjs");
/* harmony import */ var vue_router_composables__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! vue-router/composables */ "./node_modules/vue-router/composables.mjs");
...
/* harmony import */ var _store_app_api_store_ts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../store/app-api-store.ts */ "./apps/settings/src/store/app-api-store.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_9__.defineComponent)({
  __name: 'AppStore',
  setup(__props) {
    const route = (0,vue_router_composables__WEBPACK_IMPORTED_MODULE_10__.useRoute)();
    const store = (0,_store_apps_store__WEBPACK_IMPORTED_MODULE_1__.useAppsStore)();
    const appApiStore = (0,_store_app_api_store_ts__WEBPACK_IMPORTED_MODULE_8__.useAppApiStore)();
    /**
     * ID of the current active category, default is `discover`
     */
    const currentCategory = (0,vue__WEBPACK_IMPORTED_MODULE_9__.computed)(() => route.params?.category ?? 'discover');
    const appStoreLabel = (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_0__.translate)('settings', 'App Store');
    const viewLabel = (0,vue__WEBPACK_IMPORTED_MODULE_9__.computed)(() => _constants_AppsConstants__WEBPACK_IMPORTED_MODULE_2__.APPS_SECTION_ENUM[currentCategory.value] ?? store.getCategoryById(currentCategory.value)?.displayName ?? appStoreLabel);
    (0,vue__WEBPACK_IMPORTED_MODULE_9__.watchEffect)(() => {
      window.document.title = `${viewLabel.value} - ${appStoreLabel} - Nextcloud`;
    });
    // TODO this part should be migrated to pinia
    const instance = (0,vue__WEBPACK_IMPORTED_MODULE_9__.getCurrentInstance)();
    /** Is the app list loading */
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const isLoading = (0,vue__WEBPACK_IMPORTED_MODULE_9__.computed)(() => (instance?.proxy).$store.getters.loading('list'));
    (0,vue__WEBPACK_IMPORTED_MODULE_9__.onBeforeMount)(() => {
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      ...
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      if ((instance?.proxy).$store.getters.isAppApiEnabled) {
        appApiStore.fetchAllApps();
        appApiStore.updateAppsStatus();
      }
    });
    (0,vue__WEBPACK_IMPORTED_MODULE_9__.onBeforeUnmount)(() => {
...
/* harmony import */ var _nextcloud_l10n__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nextcloud/l10n */ "./node_modules/@nextcloud/l10n/dist/index.mjs");
/* harmony import */ var vue_router_composables__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! vue-router/composables */ "./node_modules/vue-router/composables.mjs");
/* harmony import */ var _store_apps_store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../store/apps-store */ "./apps/settings/src/store/apps-store.ts");
...
/* harmony import */ var _components_AppStoreSidebar_AppDeployDaemonTab_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../components/AppStoreSidebar/AppDeployDaemonTab.vue */ "./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue");
/* harmony import */ var _components_AppList_AppLevelBadge_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../components/AppList/AppLevelBadge.vue */ "./apps/settings/src/components/AppList/AppLevelBadge.vue");
/* harmony import */ var _components_AppList_AppDaemonBadge_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../components/AppList/AppDaemonBadge.vue */ "./apps/settings/src/components/AppList/AppDaemonBadge.vue");
/* harmony import */ var _composables_useAppIcon_ts__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../composables/useAppIcon.ts */ "./apps/settings/src/composables/useAppIcon.ts");
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../store */ "./apps/settings/src/store/index.js");
/* harmony import */ var _store_app_api_store_ts__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../store/app-api-store.ts */ "./apps/settings/src/store/app-api-store.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_14__.defineComponent)({
  __name: 'AppStoreSidebar',
  setup(__props) {
    const route = (0,vue_router_composables__WEBPACK_IMPORTED_MODULE_15__.useRoute)();
    const router = (0,vue_router_composables__WEBPACK_IMPORTED_MODULE_15__.useRouter)();
    const store = (0,_store_apps_store__WEBPACK_IMPORTED_MODULE_1__.useAppsStore)();
    const appApiStore = (0,_store_app_api_store_ts__WEBPACK_IMPORTED_MODULE_13__.useAppApiStore)();
    const legacyStore = (0,_store__WEBPACK_IMPORTED_MODULE_12__.useStore)();
    const appId = (0,vue__WEBPACK_IMPORTED_MODULE_14__.computed)(() => route.params.id ?? '');
    const app = (0,vue__WEBPACK_IMPORTED_MODULE_14__.computed)(() => {
      if (legacyStore.getters.isAppApiEnabled) {
        const exApp = appApiStore.getAllApps.find(app => app.id === appId.value) ?? null;
        if (exApp) {
          return exApp;
        }
      }
    ...
    const hasRating = (0,vue__WEBPACK_IMPORTED_MODULE_14__.computed)(() => app.value.appstoreData?.ratingNumOverall > 5);
    const rating = (0,vue__WEBPACK_IMPORTED_MODULE_14__.computed)(() => app.value.appstoreData?.ratingNumRecent > 5 ? app.value.appstoreData.ratingRecent : app.value.appstoreData?.ratingOverall ?? 0.5);
    const showSidebar = (0,vue__WEBPACK_IMPORTED_MODULE_14__.computed)(() => app.value !== null);
    const {
      appIcon
    } = (0,_composables_useAppIcon_ts__WEBPACK_IMPORTED_MODULE_11__.useAppIcon)(app);
    /**
     * The second text line shown on the sidebar
     */
    const licenseText = (0,vue__WEBPACK_IMPORTED_MODULE_14__.computed)(() => {
      if (!app.value) {
        return '';
      }
      if (app.value.license !== '') {
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_0__.translate)('settings', 'Version {version}, {license}-licensed', {
          version: app.value.version,
          license: app.value.licence.toString().toUpperCase()
        });
      }
      return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_0__.translate)('settings', 'Version {version}', {
        version: app.value.version
      });
    });
    const activeTab = (0,vue__WEBPACK_IMPORTED_MODULE_14__.ref)('details');
    (0,vue__WEBPACK_IMPORTED_MODULE_14__.watch)([app], () => {
     ...
     */
    const screenshotLoaded = (0,vue__WEBPACK_IMPORTED_MODULE_14__.ref)(false);
    const hasScreenshot = (0,vue__WEBPACK_IMPORTED_MODULE_14__.computed)(() => app.value?.screenshot && screenshotLoaded.value);
    /**
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_14__.watch)([app], loadScreenshot);
    (0,vue__WEBPACK_IMPORTED_MODULE_14__.onMounted)(loadScreenshot);
    return {
      __sfc: true,
      route,
      router,
      ...
      AppDeployDaemonTab: _components_AppStoreSidebar_AppDeployDaemonTab_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
      AppLevelBadge: _components_AppList_AppLevelBadge_vue__WEBPACK_IMPORTED_MODULE_9__["default"],
      AppDaemonBadge: _components_AppList_AppDaemonBadge_vue__WEBPACK_IMPORTED_MODULE_10__["default"]
    };
  }
}));
...
/* harmony import */ var _store_app_api_store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../store/app-api-store */ "./apps/settings/src/store/app-api-store.ts");
/* provided dependency */ var console = __webpack_require__(/*! ./node_modules/console-browserify/index.js */ "./node_modules/console-browserify/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup() {
    const appApiStore = (0,_store_app_api_store__WEBPACK_IMPORTED_MODULE_3__.useAppApiStore)();
    return {
      appApiStore
    };
  },
  ...
  computed: {
    ...
    apps() {
      ...
      const apps = [...this.$store.getters.getAllApps, ...exApps].filter(app => app.name.toLowerCase().search(this.search.toLowerCase()) !== -1).sort(function (a, b) {
  ...
  methods: {
    ...
    updateAll() {
      const limit = (0,p_limit__WEBPACK_IMPORTED_MODULE_4__["default"])(1);
      this.apps.filter(app => app.update).map(app => limit(() => {
        this.update(app.id);
      }));
    }
  }
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _store_apps_store_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../store/apps-store.js */ "./apps/settings/src/store/apps-store.ts");
/* harmony import */ var _AppScore_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AppScore.vue */ "./apps/settings/src/components/AppList/AppScore.vue");
/* harmony import */ var _AppLevelBadge_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./AppLevelBadge.vue */ "./apps/settings/src/components/AppList/AppLevelBadge.vue");
/* harmony import */ var _mixins_AppManagement_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../mixins/AppManagement.js */ "./apps/settings/src/mixins/AppManagement.js");
/* harmony import */ var _SvgFilterMixin_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../SvgFilterMixin.vue */ "./apps/settings/src/components/SvgFilterMixin.vue");
...
/* harmony import */ var _store_app_api_store_ts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../store/app-api-store.ts */ "./apps/settings/src/store/app-api-store.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: 'AppItem',
  components: {
    AppLevelBadge: _AppLevelBadge_vue__WEBPACK_IMPORTED_MODULE_2__["default"],
    AppScore: _AppScore_vue__WEBPACK_IMPORTED_MODULE_1__["default"],
  ...
  mixins: [_mixins_AppManagement_js__WEBPACK_IMPORTED_MODULE_3__["default"], _SvgFilterMixin_vue__WEBPACK_IMPORTED_MODULE_4__["default"]],
  props: {
    app: {
      type: Object,
      required: true
  ...
  setup() {
    const store = (0,_store_apps_store_js__WEBPACK_IMPORTED_MODULE_0__.useAppsStore)();
    const appApiStore = (0,_store_app_api_store_ts__WEBPACK_IMPORTED_MODULE_7__.useAppApiStore)();
    return {
      store,
      appApiStore,
      mdiCogOutline: _mdi_js__WEBPACK_IMPORTED_MODULE_8__.mdiCogOutline
    };
  },
  data() {
    return {
...
/* harmony import */ var _mixins_AppManagement_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../mixins/AppManagement.js */ "./apps/settings/src/mixins/AppManagement.js");
/* harmony import */ var _mdi_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @mdi/js */ "./node_modules/@mdi/js/mdi.js");
/* harmony import */ var _store_apps_store__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../store/apps-store */ "./apps/settings/src/store/apps-store.ts");
/* harmony import */ var _store_app_api_store__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../store/app-api-store */ "./apps/settings/src/store/app-api-store.ts");
/* provided dependency */ var console = __webpack_require__(/*! ./node_modules/console-browserify/index.js */ "./node_modules/console-browserify/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  mixins: [_mixins_AppManagement_js__WEBPACK_IMPORTED_MODULE_6__["default"]],
  props: {
    app: {
      type: Object,
      required: true
  ...
  setup() {
    const store = (0,_store_apps_store__WEBPACK_IMPORTED_MODULE_7__.useAppsStore)();
    const appApiStore = (0,_store_app_api_store__WEBPACK_IMPORTED_MODULE_8__.useAppApiStore)();
    return {
      store,
      appApiStore,
      mdiBug: _mdi_js__WEBPACK_IMPORTED_MODULE_9__.mdiBug,
      mdiFeatureSearch: _mdi_js__WEBPACK_IMPORTED_MODULE_9__.mdiFeatureSearch,
      mdiStar: _mdi_js__WEBPACK_IMPORTED_MODULE_9__.mdiStar,
      mdiTextBox: _mdi_js__WEBPACK_IMPORTED_MODULE_9__.mdiTextBox,
      mdiTooltipQuestion: _mdi_js__WEBPACK_IMPORTED_MODULE_9__.mdiTooltipQuestion
    };
  },
  data() {
    return {
...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=template&id=92ee9422&scoped=true":
/*!********************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=template&id=92ee9422&scoped=true ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  ...
  return _vm.daemon ? _c("span", {
    staticClass: "app-daemon-badge",
    attrs: {
      title: _vm.daemon.name
    }
  }, [_c(_setup.NcIconSvgWrapper, {
    attrs: {
      path: _setup.mdiFileChart,
      size: 20,
      inline: ""
    }
...
var render = function render() {
  ...
  return _c(_vm.listView ? "tr" : _vm.inline ? "article" : "li", {
  ...
  }, [!_vm.app?.app_api && _vm.shouldDisplayDefaultIcon ? _c("div", {
    staticClass: "icon-settings-dark"
  }) : _vm.app.app_api && _vm.shouldDisplayDefaultIcon ? _c("NcIconSvgWrapper", {
    staticStyle: {
      "min-width": "auto",
      "min-height": "auto",
      height: "100%"
    ...
    attrs: {
      path: _vm.mdiCogOutline,
      size: _vm.listView ? 24 : 48
    }
  }) : _vm.listView && _vm.app.preview && !_vm.app.app_api ? _c("svg", {
    attrs: {
      width: "32",
      height: "32",
      viewBox: "0 0 32 32"
...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=template&id=c31af206&scoped=true":
/*!********************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=template&id=c31af206&scoped=true ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function render() {
  var _vm = this,
    _c = _vm._self._c,
    _setup = _vm._self._setupProxy;
  return _vm.app?.daemon ? _c(_setup.NcAppSidebarTab, {
    attrs: {
      id: "daemon",
      name: _vm.t("settings", "Daemon"),
      order: 3
    },
    scopedSlots: _vm._u([{
      key: "icon",
      ...
      proxy: true
    }], null, false, 1746493066)
  }, [_vm._v(" "), _c("div", {
    staticClass: "daemon"
  }, [_c("h4", [_vm._v(_vm._s(_vm.t("settings", "Deploy Daemon")))]), _vm._v(" "), _c("p", [_c("b", [_vm._v(_vm._s(_vm.t("settings", "Type")))]), _vm._v(": " + _vm._s(_vm.app?.daemon.accepts_deploy_id))]), _vm._v(" "), _c("p", [_c("b", [_vm._v(_vm._s(_vm.t("settings", "Name")))]), _vm._v(": " + _vm._s(_vm.app?.daemon.name))]), _vm._v(" "), _c("p", [_c("b", [_vm._v(_vm._s(_vm.t("settings", "Display Name")))]), _vm._v(": " + _vm._s(_vm.app?.daemon.display_name))]), _vm._v(" "), _c("p", [_c("b", [_vm._v(_vm._s(_vm.t("settings", "GPUs support")))]), _vm._v(": " + _vm._s(_setup.gpuSupport))]), _vm._v(" "), _c("p", [_c("b", [_vm._v(_vm._s(_vm.t("settings", "Compute device")))]), _vm._v(": " + _vm._s(_vm.app?.daemon?.deploy_config?.computeDevice?.label))])])]) : _vm._e();
};
var staticRenderFns = [];
render._withStripped = true;
...
var render = function render() {
  ...
  }) : _vm._e()]), _vm._v(" "), !_vm.defaultDeployDaemonAccessible ? _c("p", {
    staticClass: "warning"
  ...
  }), 0)]) : _vm._e()]), _vm._v(" "), _vm.lastModified && !_vm.app.shipped ? _c("div", {
  ...
  return _c(_setup.NcAppNavigation, {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function () {
        return [_setup.appstoreEnabled ? _c(_setup.NcAppNavigationItem, {
        ...
        }), _vm._v(" "), _setup.store.updateCount > 0 ? _c(_setup.NcAppNavigationItem, {
          attrs: {
          ...
          scopedSlots: _vm._u([{
            key: "counter",
            fn: function () {
              return [_c(_setup.NcCounterBubble, [_vm._v(_vm._s(_setup.store.updateCount))])];
            },
            proxy: true
          }, {
            key: "icon",
...
var render = function render() {
  ...
  return _setup.showSidebar ? _c(_setup.NcAppSidebar, {
    ...
    scopedSlots: _vm._u([!_setup.hasScreenshot ? {
      ...
      fn: function () {
        ...
        }), _vm._v(" "), _setup.app.app_api && _setup.app.daemon ? _c(_setup.AppDaemonBadge, {
          attrs: {
            daemon: _setup.app.daemon
          }
        }) : _vm._e(), _vm._v(" "), _setup.hasRating ? _c(_setup.AppScore, {
          attrs: {
            score: _setup.rating
          }
        }) : _vm._e()], 1)];
  ...
  }), _vm._v(" "), _c(_setup.AppDeployDaemonTab, {
    attrs: {
      app: _setup.app
    }
  })], 1) : _vm._e();
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=style&index=0&id=92ee9422&scoped=true&lang=scss":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=style&index=0&id=92ee9422&scoped=true&lang=scss ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.app-daemon-badge[data-v-92ee9422] {
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=style&index=0&id=c31af206&scoped=true&lang=scss":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=style&index=0&id=c31af206&scoped=true&lang=scss ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.daemon[data-v-c31af206] {
  padding: 20px;
}
.daemon h4[data-v-c31af206] {
  font-weight: bold;
  margin: 10px auto;
}`, ""]);
// Exports
...
.settings-markdown[data-v-11f4a1b0] a {
  text-decoration: underline;
}
.settings-markdown[data-v-11f4a1b0] a::after {
  content: "↗";
...
/***/ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=style&index=0&id=92ee9422&scoped=true&lang=scss":
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=style&index=0&id=92ee9422&scoped=true&lang=scss ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! !../../../../../node_modules/style-loader/dist/runtime/styleTagTransform.js */ "./node_modules/style-loader/dist/runtime/styleTagTransform.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDaemonBadge_vue_vue_type_style_index_0_id_92ee9422_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../../../../node_modules/css-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/sass-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./AppDaemonBadge.vue?vue&type=style&index=0&id=92ee9422&scoped=true&lang=scss */ "./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=style&index=0&id=92ee9422&scoped=true&lang=scss");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDaemonBadge_vue_vue_type_style_index_0_id_92ee9422_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDaemonBadge_vue_vue_type_style_index_0_id_92ee9422_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDaemonBadge_vue_vue_type_style_index_0_id_92ee9422_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDaemonBadge_vue_vue_type_style_index_0_id_92ee9422_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! !../../../../../node_modules/style-loader/dist/runtime/styleTagTransform.js */ "./node_modules/style-loader/dist/runtime/styleTagTransform.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDeployDaemonTab_vue_vue_type_style_index_0_id_c31af206_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../../../../node_modules/css-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/sass-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./AppDeployDaemonTab.vue?vue&type=style&index=0&id=c31af206&scoped=true&lang=scss */ "./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=style&index=0&id=c31af206&scoped=true&lang=scss");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDeployDaemonTab_vue_vue_type_style_index_0_id_c31af206_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDeployDaemonTab_vue_vue_type_style_index_0_id_c31af206_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDeployDaemonTab_vue_vue_type_style_index_0_id_c31af206_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDeployDaemonTab_vue_vue_type_style_index_0_id_c31af206_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _AppDaemonBadge_vue_vue_type_template_id_92ee9422_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AppDaemonBadge.vue?vue&type=template&id=92ee9422&scoped=true */ "./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=template&id=92ee9422&scoped=true");
/* harmony import */ var _AppDaemonBadge_vue_vue_type_script_setup_true_lang_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AppDaemonBadge.vue?vue&type=script&setup=true&lang=ts */ "./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=script&setup=true&lang=ts");
/* harmony import */ var _AppDaemonBadge_vue_vue_type_style_index_0_id_92ee9422_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./AppDaemonBadge.vue?vue&type=style&index=0&id=92ee9422&scoped=true&lang=scss */ "./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=style&index=0&id=92ee9422&scoped=true&lang=scss");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _AppDaemonBadge_vue_vue_type_script_setup_true_lang_ts__WEBPACK_IMPORTED_MODULE_1__["default"],
  _AppDaemonBadge_vue_vue_type_template_id_92ee9422_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _AppDaemonBadge_vue_vue_type_template_id_92ee9422_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "92ee9422",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "apps/settings/src/components/AppList/AppDaemonBadge.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _AppDeployDaemonTab_vue_vue_type_template_id_c31af206_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AppDeployDaemonTab.vue?vue&type=template&id=c31af206&scoped=true */ "./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=template&id=c31af206&scoped=true");
/* harmony import */ var _AppDeployDaemonTab_vue_vue_type_script_setup_true_lang_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AppDeployDaemonTab.vue?vue&type=script&setup=true&lang=ts */ "./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=script&setup=true&lang=ts");
/* harmony import */ var _AppDeployDaemonTab_vue_vue_type_style_index_0_id_c31af206_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./AppDeployDaemonTab.vue?vue&type=style&index=0&id=c31af206&scoped=true&lang=scss */ "./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=style&index=0&id=c31af206&scoped=true&lang=scss");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _AppDeployDaemonTab_vue_vue_type_script_setup_true_lang_ts__WEBPACK_IMPORTED_MODULE_1__["default"],
  _AppDeployDaemonTab_vue_vue_type_template_id_c31af206_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _AppDeployDaemonTab_vue_vue_type_template_id_c31af206_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "c31af206",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=script&setup=true&lang=ts":
/*!****************************************************************************************************!*\
  !*** ./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=script&setup=true&lang=ts ***!
  \****************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDaemonBadge_vue_vue_type_script_setup_true_lang_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js!../../../../../node_modules/ts-loader/index.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./AppDaemonBadge.vue?vue&type=script&setup=true&lang=ts */ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=script&setup=true&lang=ts");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDaemonBadge_vue_vue_type_script_setup_true_lang_ts__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=script&setup=true&lang=ts":
/*!****************************************************************************************************************!*\
  !*** ./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=script&setup=true&lang=ts ***!
  \****************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDeployDaemonTab_vue_vue_type_script_setup_true_lang_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js!../../../../../node_modules/ts-loader/index.js??clonedRuleSet-4.use[1]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./AppDeployDaemonTab.vue?vue&type=script&setup=true&lang=ts */ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=script&setup=true&lang=ts");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDeployDaemonTab_vue_vue_type_script_setup_true_lang_ts__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/***/ "./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=template&id=92ee9422&scoped=true":
/*!***********************************************************************************************************!*\
  !*** ./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=template&id=92ee9422&scoped=true ***!
  \***********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDaemonBadge_vue_vue_type_template_id_92ee9422_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDaemonBadge_vue_vue_type_template_id_92ee9422_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDaemonBadge_vue_vue_type_template_id_92ee9422_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./AppDaemonBadge.vue?vue&type=template&id=92ee9422&scoped=true */ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=template&id=92ee9422&scoped=true");
...
/***/ "./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=template&id=c31af206&scoped=true":
/*!***********************************************************************************************************************!*\
  !*** ./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=template&id=c31af206&scoped=true ***!
  \***********************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDeployDaemonTab_vue_vue_type_template_id_c31af206_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDeployDaemonTab_vue_vue_type_template_id_c31af206_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDeployDaemonTab_vue_vue_type_template_id_c31af206_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./AppDeployDaemonTab.vue?vue&type=template&id=c31af206&scoped=true */ "./node_modules/babel-loader/lib/index.js!./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=template&id=c31af206&scoped=true");
...
/***/ "./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=style&index=0&id=92ee9422&scoped=true&lang=scss":
/*!**************************************************************************************************************************!*\
  !*** ./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=style&index=0&id=92ee9422&scoped=true&lang=scss ***!
  \**************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDaemonBadge_vue_vue_type_style_index_0_id_92ee9422_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/css-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/sass-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./AppDaemonBadge.vue?vue&type=style&index=0&id=92ee9422&scoped=true&lang=scss */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppList/AppDaemonBadge.vue?vue&type=style&index=0&id=92ee9422&scoped=true&lang=scss");
...
/***/ "./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=style&index=0&id=c31af206&scoped=true&lang=scss":
/*!**************************************************************************************************************************************!*\
  !*** ./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=style&index=0&id=c31af206&scoped=true&lang=scss ***!
  \**************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_AppDeployDaemonTab_vue_vue_type_style_index_0_id_c31af206_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/css-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/sass-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./AppDeployDaemonTab.vue?vue&type=style&index=0&id=c31af206&scoped=true&lang=scss */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/AppStoreSidebar/AppDeployDaemonTab.vue?vue&type=style&index=0&id=c31af206&scoped=true&lang=scss");
...
//# sourceMappingURL=settings-apps-view-settings-apps-view.js.map?v=e170821208b59adc4132