  ...
  computed: {
    ...
    realPreviewUrl() {
      ...
      if ((0,_nextcloud_sharing_public__WEBPACK_IMPORTED_MODULE_2__.isPublicShare)()) {
        return (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)(`/apps/files_sharing/publicpreview/${(0,_nextcloud_sharing_public__WEBPACK_IMPORTED_MODULE_2__.getSharingToken)()}?fileId=${this.fileid}&file=${(0,_nextcloud_paths__WEBPACK_IMPORTED_MODULE_0__.encodePath)(this.filename)}&x=${previewWidth}&y=${previewWidth}&a=1`);
      }
...
var render = function render() {
  ...
  return _c("NcModal", [_c("div", {
    ...
    attrs: {
      name: _vm.t("files", "Submitting fields…")
    }
...
//# sourceMappingURL=apps_files_src_views_TemplatePicker_vue-data_image_svg_xml_3c_21--_20-_20SPDX-FileCopyrightTe-15ea2e-apps_files_src_views_TemplatePicker_vue-data_image_svg_xml_3c_21--_20-_20SPDX-FileCopyrightTe-15ea2e.js.map?v=189293049087f68b423f