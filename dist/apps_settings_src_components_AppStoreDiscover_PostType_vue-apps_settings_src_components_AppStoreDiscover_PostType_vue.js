...
const useLocalizedValue = dict => {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_1__.computed)(() => !dict?.value ? null : getLocalizedValue(dict.value, language));
};
...
const apps = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_0__.loadState)('core', 'apps');
    ...
    href: {
      ...
      handler() {
        ...
        if (match[2]) {
          ...
          this.linkProps = {
            href: (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)(`/apps/${appId}${match[2]}`)
          };
          return;
        }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_5__.defineComponent)({
  ...
  setup(props) {
    ...
    const localizedMedia = (0,_composables_useGetLocalizedValue__WEBPACK_IMPORTED_MODULE_2__.useLocalizedValue)((0,vue__WEBPACK_IMPORTED_MODULE_5__.computed)(() => props.media?.content));
    ...
    const mediaAlt = (0,vue__WEBPACK_IMPORTED_MODULE_5__.computed)(() => localizedMedia.value?.alt ?? '');
    const isImage = (0,vue__WEBPACK_IMPORTED_MODULE_5__.computed)(() => mediaSources?.value?.[0].mime.startsWith('image/') === true);
    /**
     ...
     */
    const mediaLink = (0,vue__WEBPACK_IMPORTED_MODULE_5__.computed)(() => localizedMedia.value?.link ?? props.link);
    const hasPlaybackEnded = (0,vue__WEBPACK_IMPORTED_MODULE_5__.ref)(false);
    const showPlayVideo = (0,vue__WEBPACK_IMPORTED_MODULE_5__.computed)(() => localizedMedia.value?.link && hasPlaybackEnded.value);
    /**
...
//# sourceMappingURL=apps_settings_src_components_AppStoreDiscover_PostType_vue-apps_settings_src_components_AppStoreDiscover_PostType_vue.js.map?v=af583d105ee9a2ce2fa8