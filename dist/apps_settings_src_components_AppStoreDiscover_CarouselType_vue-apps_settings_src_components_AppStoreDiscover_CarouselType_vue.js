...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_6__.defineComponent)({
  ...
  setup(props) {
    ...
    const internalId = (0,vue__WEBPACK_IMPORTED_MODULE_6__.computed)(() => props.id ?? (Math.random() + 1).toString(36).substring(7));
    const headingId = (0,vue__WEBPACK_IMPORTED_MODULE_6__.computed)(() => `${internalId.value}-h`);
...
var render = function render() {
  ...
  return _c("section", {
    attrs: {
      ...
      "aria-labelledby": _vm.headingId ? `${_vm.headingId}` : undefined
    }
  }, [_vm.headline ? _c("h3", {
    attrs: {
      id: _vm.headingId
    ...
    key: _vm.shownElement.id ?? _vm.currentIndex,
    attrs: {
      "aria-labelledby": `${_vm.internalId}-tab-${_vm.currentIndex}`,
      "dom-id": `${_vm.internalId}-tabpanel-${_vm.currentIndex}`,
      inline: "",
      role: "tabpanel"
    }
    ...
    return _c("NcButton", {
      key: index,
      attrs: {
        id: `${_vm.internalId}-tab-${index}`,
        "aria-label": _vm.t("settings", "{index} of {total}", {
          index,
          total: _vm.content.length
        }),
        "aria-controls": `${_vm.internalId}-tabpanel-${index}`,
        "aria-selected": `${_vm.currentIndex === index - 1}`,
        role: "tab",
        type: "tertiary-no-background"
      },
      on: {
...
//# sourceMappingURL=apps_settings_src_components_AppStoreDiscover_CarouselType_vue-apps_settings_src_components_AppStoreDiscover_CarouselType_vue.js.map?v=810771077b3ae9f8662f