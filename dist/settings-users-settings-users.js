...
/* harmony import */ var is_svg__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! is-svg */ "./node_modules/is-svg/index.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_5__.defineComponent)({
  ...
  methods: {
    isSvg: is_svg__WEBPACK_IMPORTED_MODULE_6__["default"],
    /**
...
/* harmony import */ var _logger_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../logger.ts */ "./apps/settings/src/logger.ts");




vue__WEBPACK_IMPORTED_MODULE_1__["default"].directive('elementVisibility', _vueuse_components__WEBPACK_IMPORTED_MODULE_2__.vElementVisibility);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (vue__WEBPACK_IMPORTED_MODULE_1__["default"].extend({
  ...
  mounted() {
    ...
    this.resizeObserver = new ResizeObserver(debounce__WEBPACK_IMPORTED_MODULE_3___default()(() => {
      this.headerHeight = thead?.clientHeight ?? 0;
      this.tableHeight = root?.clientHeight ?? 0;
      _logger_ts__WEBPACK_IMPORTED_MODULE_0__["default"].debug('VirtualList resizeObserver updated');
      this.onScroll();
    }, 100, false));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_17__.defineComponent)({
  ...
  setup(__props) {
    ...
    const selectedGroup = (0,vue__WEBPACK_IMPORTED_MODULE_17__.computed)(() => route.params?.selectedGroup);
    ...
    const settings = (0,vue__WEBPACK_IMPORTED_MODULE_17__.computed)(() => store.getters.getServerData);
    /** True if the current user is a (delegated) admin */
    const isAdminOrDelegatedAdmin = (0,vue__WEBPACK_IMPORTED_MODULE_17__.computed)(() => settings.value.isAdmin || settings.value.isDelegatedAdmin);
    ...
    return {
      ...
      mdiAccountGroup: _mdi_js__WEBPACK_IMPORTED_MODULE_19__.mdiAccountGroup,
      ...
      mdiHistory: _mdi_js__WEBPACK_IMPORTED_MODULE_19__.mdiHistory,
      t: _nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    groups() {
      ...
      return this.$store.getters.getGroups.filter(group => group.id !== '__nc_internal_recent' && group.id !== 'disabled').sort((a, b) => a.name.localeCompare(b.name));
    },
    subAdminsGroups() {
...
/* harmony import */ var _nextcloud_vue_dist_Components_NcLoadingIcon_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @nextcloud/vue/dist/Components/NcLoadingIcon.js */ "./node_modules/@nextcloud/vue/dist/Components/NcLoadingIcon.mjs");
/* harmony import */ var _nextcloud_vue_dist_Components_NcProgressBar_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @nextcloud/vue/dist/Components/NcProgressBar.js */ "./node_modules/@nextcloud/vue/dist/Components/NcProgressBar.mjs");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    NcLoadingIcon: _nextcloud_vue_dist_Components_NcLoadingIcon_js__WEBPACK_IMPORTED_MODULE_5__["default"],
    NcProgressBar: _nextcloud_vue_dist_Components_NcProgressBar_js__WEBPACK_IMPORTED_MODULE_6__["default"],
  ...
  mixins: [_mixins_UserRowMixin_js__WEBPACK_IMPORTED_MODULE_10__["default"]],
  props: {
    user: {
      type: Object,
      required: true
  ...
  computed: {
    ...
    canEdit() {
      return (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_1__.getCurrentUser)().uid !== this.user.id || this.settings.isAdmin || this.settings.isDelegatedAdmin;
    },
    userQuota() {
      let quota = this.user.quota?.quota;
      if (quota === 'default') {
    ...
    editedUserQuota: {
      get() {
        ...
        if (this.settings.defaultQuota !== _utils_userUtils_ts__WEBPACK_IMPORTED_MODULE_11__.unlimitedQuota.id && (0,_nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.parseFileSize)(this.settings.defaultQuota, true) >= 0) {
          // if value is valid, let's map the quotaOptions or return custom quota
          return {
...
/* harmony import */ var _components_UserList_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/UserList.vue */ "./apps/settings/src/components/UserList.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_4__.defineComponent)({
  ...
  computed: {
    pageHeading() {
      if (this.selectedGroupDecoded === null) {
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_0__.translate)('settings', 'All accounts');
      }
      const matchHeading = {
      ...
      return matchHeading[this.selectedGroupDecoded] ?? (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_0__.translate)('settings', 'Account group: {group}', {
  ...
  created() {
    ...
    (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_1__.emit)('settings:user-management:loaded');
  },
  methods: {
    t: _nextcloud_l10n__WEBPACK_IMPORTED_MODULE_0__.translate,
    /**
...
var render = function render() {
  ...
  return _c("NcDialog", _vm._g({
    ...
    class: ["dialog__item dialog__managers", {
...
var render = function render() {
  ...
  }, [_c("span", [_vm._v(_vm._s(_vm.t("settings", "Groups")))])]), _vm._v(" "), _vm.subAdminsGroups.length > 0 && (_vm.settings.isAdmin || _vm.settings.isDelegatedAdmin) ? _c("th", {
    staticClass: "header__cell header__cell--large",
    attrs: {
...
var render = function render() {
  ...
  }, [_vm._v("\n\t\t\t" + _vm._s(_vm.userGroupsLabels) + "\n\t\t")]) : _vm._e()], 2), _vm._v(" "), _vm.subAdminsGroups.length > 0 && (_vm.settings.isAdmin || _vm.settings.isDelegatedAdmin) ? _c("td", {
    staticClass: "row__cell row__cell--large row__cell--multiline",
    attrs: {
      "data-cy-user-list-cell-subadmins": ""
    }
  }, [_vm.editing && (_vm.settings.isAdmin || _vm.settings.isDelegatedAdmin) && _vm.subAdminsGroups.length > 0 ? [_c("label", {
    staticClass: "hidden-visually",
    attrs: {
        ...
        return [_c(_setup.NcActionText, {
          scopedSlots: _vm._u([{
            ...
            fn: function () {
              return [_c(_setup.NcIconSvgWrapper, {
                attrs: {
                  path: _setup.mdiAccountGroup
                }
              })];
            },
            proxy: true
          }], null, false, 3607647275)
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _chunks_NcAppNavigationCaption_DPUdrh1W_mjs__WEBPACK_IMPORTED_MODULE_0__.N)
/* harmony export */ });
/* harmony import */ var _chunks_NcAppNavigationCaption_DPUdrh1W_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../chunks/NcAppNavigationCaption-DPUdrh1W.mjs */ "./node_modules/@nextcloud/vue/dist/chunks/NcAppNavigationCaption-DPUdrh1W.mjs");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _chunks_NcAppSettingsDialog_4B3lv0WQ_mjs__WEBPACK_IMPORTED_MODULE_0__.N)
/* harmony export */ });
/* harmony import */ var _chunks_NcAppSettingsDialog_4B3lv0WQ_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../chunks/NcAppSettingsDialog-4B3lv0WQ.mjs */ "./node_modules/@nextcloud/vue/dist/chunks/NcAppSettingsDialog-4B3lv0WQ.mjs");
...
//# sourceMappingURL=settings-users-settings-users.js.map?v=fb858297a7f09c761c01