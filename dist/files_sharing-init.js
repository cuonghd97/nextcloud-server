...
/* harmony import */ var _mdi_svg_svg_close_svg_raw__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @mdi/svg/svg/close.svg?raw */ "./node_modules/@mdi/svg/svg/close.svg?raw");
/* harmony import */ var _views_shares__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../views/shares */ "./apps/files_sharing/src/views/shares.ts");
...
const action = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_2__.FileAction({
  ...
  iconSvgInline: () => _mdi_svg_svg_close_svg_raw__WEBPACK_IMPORTED_MODULE_6__,
  enabled: (nodes, view) => {
    if (view.id !== _views_shares__WEBPACK_IMPORTED_MODULE_7__.pendingSharesViewId) {
      return false;
    }
    if (nodes.length === 0) {
      return false;
  ...
  async exec(node) {
    try {
      ...
      await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_5__["default"].delete(url);
      // Remove from current view
      (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_0__.emit)('files:node:deleted', node);
      return true;
    } catch (error) {
...
/* harmony import */ var _files_src_actions_sidebarAction__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../files/src/actions/sidebarAction */ "./apps/files/src/actions/sidebarAction.ts");
/* harmony import */ var _utils_AccountIcon__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utils/AccountIcon */ "./apps/files_sharing/src/utils/AccountIcon.ts");
...
const action = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.FileAction({
  ...
  displayName(nodes) {
    ...
    if (shareTypes.length > 0 || node.owner !== (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_7__.getCurrentUser)()?.uid || isExternal(node)) {
  ...
  title(nodes) {
    const node = nodes[0];
    if (node.owner && (node.owner !== (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_7__.getCurrentUser)()?.uid || isExternal(node))) {
    ...
    switch (sharee.type) {
      case _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_2__.ShareType.User:
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('files_sharing', 'Shared with {user}', {
          user: sharee['display-name']
        });
      case _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_2__.ShareType.Group:
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('files_sharing', 'Shared with group {group}', {
          group: sharee['display-name'] ?? sharee.id
        });
      default:
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('files_sharing', 'Shared with others');
    }
  },
  iconSvgInline(nodes) {
    const node = nodes[0];
    ...
    // Link shares
    if (shareTypes.includes(_nextcloud_sharing__WEBPACK_IMPORTED_MODULE_2__.ShareType.Link) || shareTypes.includes(_nextcloud_sharing__WEBPACK_IMPORTED_MODULE_2__.ShareType.Email)) {
      return _mdi_svg_svg_link_svg_raw__WEBPACK_IMPORTED_MODULE_5__;
    }
    // Group shares
    if (shareTypes.includes(_nextcloud_sharing__WEBPACK_IMPORTED_MODULE_2__.ShareType.Group) || shareTypes.includes(_nextcloud_sharing__WEBPACK_IMPORTED_MODULE_2__.ShareType.RemoteGroup)) {
      return _mdi_svg_svg_account_group_svg_raw__WEBPACK_IMPORTED_MODULE_3__;
    }
    // Circle shares
    if (shareTypes.includes(_nextcloud_sharing__WEBPACK_IMPORTED_MODULE_2__.ShareType.Team)) {
      return _core_img_apps_circles_svg_raw__WEBPACK_IMPORTED_MODULE_6__;
    }
    if (node.owner && (node.owner !== (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_7__.getCurrentUser)()?.uid || isExternal(node))) {
      return (0,_utils_AccountIcon__WEBPACK_IMPORTED_MODULE_9__.generateAvatarSvg)(node.owner, isExternal(node));
    }
    return _mdi_svg_svg_account_plus_svg_raw__WEBPACK_IMPORTED_MODULE_4__;
  },
  enabled(nodes) {
    ...
    if (node.owner !== (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_7__.getCurrentUser)()?.uid || isExternal(node)) {
      return true;
    }
  ...
  async exec(node, view, dir) {
    ...
    if ((node.permissions & _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.Permission.READ) !== 0) {
      ...
      return _files_src_actions_sidebarAction__WEBPACK_IMPORTED_MODULE_8__.action.exec(node, view, dir);
    }
    return null;
  },
  inline: () => true
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _nextcloud_files__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nextcloud/files */ "./node_modules/@nextcloud/files/dist/index.mjs");
/* harmony import */ var _filters_AccountFilter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./filters/AccountFilter */ "./apps/files_sharing/src/filters/AccountFilter.ts");
/* harmony import */ var _new_newFileRequest_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./new/newFileRequest.ts */ "./apps/files_sharing/src/new/newFileRequest.ts");
...
/* harmony import */ var _views_shares__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./views/shares */ "./apps/files_sharing/src/views/shares.ts");
/* harmony import */ var _actions_acceptShareAction__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./actions/acceptShareAction */ "./apps/files_sharing/src/actions/acceptShareAction.ts");
/* harmony import */ var _actions_openInFilesAction__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./actions/openInFilesAction */ "./apps/files_sharing/src/actions/openInFilesAction.ts");
/* harmony import */ var _actions_rejectShareAction__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./actions/rejectShareAction */ "./apps/files_sharing/src/actions/rejectShareAction.ts");
/* harmony import */ var _actions_restoreShareAction__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./actions/restoreShareAction */ "./apps/files_sharing/src/actions/restoreShareAction.ts");
/* harmony import */ var _actions_sharingStatusAction__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./actions/sharingStatusAction */ "./apps/files_sharing/src/actions/sharingStatusAction.ts");
/**
...
(0,_views_shares__WEBPACK_IMPORTED_MODULE_4__["default"])();
(0,_nextcloud_files__WEBPACK_IMPORTED_MODULE_0__.addNewFileMenuEntry)(_new_newFileRequest_ts__WEBPACK_IMPORTED_MODULE_2__.entry);
...
(0,_filters_AccountFilter__WEBPACK_IMPORTED_MODULE_1__.registerAccountFilter)();
...
const NewFileRequestDialogVue = (0,vue__WEBPACK_IMPORTED_MODULE_4__.defineAsyncComponent)(() => Promise.all(/*! import() */[__webpack_require__.e("core-common"), __webpack_require__.e("apps_files_sharing_src_models_Share_ts-apps_files_sharing_src_utils_GeneratePassword_ts-node_-14f1ab"), __webpack_require__.e("apps_files_sharing_src_components_NewFileRequestDialog_vue")]).then(__webpack_require__.bind(__webpack_require__, /*! ../components/NewFileRequestDialog.vue */ "./apps/files_sharing/src/components/NewFileRequestDialog.vue")));
...
/******/ 			return "" + chunkId + "-" + chunkId + ".js?v=" + {"node_modules_nextcloud_dialogs_dist_chunks_index-D5FJasts_mjs":"08b958f56528298001fd","apps_files_sharing_src_models_Share_ts-apps_files_sharing_src_utils_GeneratePassword_ts-node_-14f1ab":"b9a8b0e6d4f56a3c7dc6","apps_files_sharing_src_components_NewFileRequestDialog_vue":"702b480563f3881bb548","apps_files_sharing_src_views_FilesHeaderNoteToRecipient_vue":"78931e3bdcbe8c8657f3","node_modules_mime_dist_src_index_js":"879cdfe808888dd61e8a","data_image_svg_xml_3c_21--_20-_20SPDX-FileCopyrightText_202020_20Google_20Inc_20-_20SPDX-Lice-84639e":"2dcb905bc800668fb1ac"}[chunkId] + "";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=files_sharing-init.js.map?v=fad4fc48a67937455187